          ...
          <div>
            ...
            <div className="mt-6">
              <div className="mb-2 flex items-center justify-between">
                <p className="text-xs font-semibold uppercase tracking-wideish text-stone-500">Size</p>
            ...
            <div className="mt-6 flex items-center gap-4">
              ...
              <p className={cn("text-sm", stock === 0 ? "text-error" : stock < 10 ? "text-accent" : "text-stone-500")}>
            ...
            <div className="mt-8 grid grid-cols-3 gap-3 border-t border-stone-200 pt-6 text-center">
              <div>
                <Truck size={18} className="mx-auto mb-1.5 text-stone-500" />
                <p className="text-xs text-stone-500">Free shipping over ₹2000</p>
              </div>
              <div>
                <RotateCcw size={18} className="mx-auto mb-1.5 text-stone-500" />
                <p className="text-xs text-stone-500">7-day easy returns</p>
              </div>
              <div>
                <ShieldCheck size={18} className="mx-auto mb-1.5 text-stone-500" />
                <p className="text-xs text-stone-500">Cash on Delivery</p>
              </div>
            </div>
